...
function processingResponseData(
  ...
  if (typeof responses["200"]["x-codegen-request-body-name"] === "undefined") {
                ...
                Object.keys(jsonYaml.components[componentsObject[2]]).forEach(
                  (element) => {
                    if (componentsObject[3] === element) {
                      ...
                      const className = setCamelCase(element);
              ...
              _.forEach(
                ...
                (propertiesValue, propertiesKey) => {
                  ...
                  if (
                    ...
                    // 클래스 변수명
                    const className = setCamelCase(componentsObject[3]);
                    ...
                    importRequestDto.add({
                      className: setPascalCase(className) + "Data",
                      from: _.camelCase(className),
                    });
                  } else if (
                    typeof propertiesValue.items === "undefined" &&
                    ...
                    // 클래스 변수명
                    const className = setCamelCase(componentsObject[3]);
                    const importName = setPascalCase(componentsObject[3]);
    ...
    projectStructure.importRequestDto.push({
      ...
      from: `../dto/${_.camelCase(className)}.dto`,
    });
